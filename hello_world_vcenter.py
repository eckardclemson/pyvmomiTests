...
# from https://developercenter.vmware.com/samples?categories=Sample&keywords=&tags=Python&filters=&sort=score
...
## From /usr/lib/python2.6/site-packages/salt/utils/vmware.py
#    try:
#        import ssl
